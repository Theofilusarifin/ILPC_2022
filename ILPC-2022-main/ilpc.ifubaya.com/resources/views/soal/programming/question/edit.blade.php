...
<div class="content-body">
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{ route('soal.prg.question.update', ['contest' => $contest->id, 'question' => $question->id]) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-control mb-1">
                    ...
                    <input value="{{ $question->judul }}" type='text' id="judul" class='form-control' name="judul" />
                </div>

                <div class="form-control mb-1">
                    <label for="time_limit" class="form-label">Time Limit</label>
                    <div class="input-group input-group-lg bootstrap-touchspin">
                        <input value="{{ $question->time_limit }}" id="time_limit" name="time_limit" type="text" class="touchspin form-control" value="0" data-bts-step="0.5" data-bts-decimals="2">
                    </div>
                </div>
                        ...
                        <div class="col-5">
                            <div class="alert alert-warning" role="alert">
                                <div class="alert-body">
                                    Kosongi Upload File apabila tidak ingin mengupdate Input File (.in)
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-control mb-1">
                    ...
                    <div class="row">
                        <div class="col-5">
                            <div class="alert alert-warning" role="alert">
                                <div class="alert-body">
                                    Kosongi Upload File apabila tidak ingin mengupdate Output File (.out)
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {{-- <div class="form-control mb-1">
                    ...
                    <div action="#" class="dropzone dropzone-area dz-clickable mb-3" id="dpz-remove-all-thumb">
                        <div name="input_file" class="dz-message">Drop Input File (.in) here or click to upload.</div>
                    </div>

                    <div action="#" class="dropzone dropzone-area dz-clickable" id="dpz-remove-thumb">
                        <div name="output_file" class="dz-message">Drop Ouput File (.out) here or click to upload.</div>
                    </div>
                </div> --}}
