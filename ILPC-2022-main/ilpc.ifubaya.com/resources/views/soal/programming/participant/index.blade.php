@extends('soal.layouts.app', ['pageActive' => 'soal.prg.index', 'pageTitle' => 'Contest Participant'])
@section('header')
<style>
    ul {
        margin: 0;
        ...
        <div class="card-body">
            ...
            <div class="row mb-1">
                <div class="col-4" class="mb-1">
                    ...
                    <form method="post" action="{{ route('soal.prg.participant.store', $contest->id) }}" id="formStoreParticipant">
                        @csrf
                        <select id="pilih_team" class="select2 form-select" tabindex="-1" aria-hidden="true" multiple="multiple" name="team_id[]" onchange="enableButton()">
            ...
            <table class="table mb-4">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button class="btn btn-outline-danger mt-1" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="getPrgDataToDelete({{ $contest->id. ','. $team_join->id }})" style="width:100%;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="" id="participantPrgContestDelete">
                    @csrf
            ...
            <div class="modal-footer">
                <button form="participantPrgContestDelete" type="submit" class="btn btn-primary" data-bs-dismiss="modal">Delete</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function getPrgDataToDelete(contest_id, team_id){
        $("#participantPrgContestDelete").attr("action", "{{ route('soal.prg.index') }}/"+contest_id+"/participant/destroy/"+team_id);
    }
