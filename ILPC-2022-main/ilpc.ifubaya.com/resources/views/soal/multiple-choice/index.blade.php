...
<div class="content-body">
        ...
        <div class="card-body">
            <div class="card-text">
                <p>
                    ...
                    Di sini, anda dapat menambah dan melakukan pengaturan terhadap soal multiple choice. <br>
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">List of Multiple Choice Contest</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
                @php
            ...
            <form method="get" action="{{ route('soal.mc.search') }}" class="mt-2">
                {{-- @csrf --}}
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="table-responsive">
                <table class="table mb-2">
                    ...
                    <tr>
                        ...
                        <td width="8%">
                            <a class="btn btn-outline-info" href="{{ route('soal.mc.show',$contest->id) }}" style="width:100%;">
                                <i data-feather="book-open"></i></a>
                                
                            @if (Auth::user()->role == 'soal')
                            <button class="btn btn-outline-danger mt-1" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="getMcDataToDelete({{ $contest->id }})" style="width:100%;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('soal.mc.store') }}" id="soalEssaysStore">
                    @csrf
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="" id="soalMcDelete">
                    @csrf
                    <p>Apakah anda yakin untuk delete Contest Multiple Choice ini?</p>
                </form>
            </div>
            <div class="modal-footer">
                <button form="soalMcDelete" type="submit" class="btn btn-primary" data-bs-dismiss="modal">Delete</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function getMcDataToDelete(id){
        $("#soalMcDelete").attr("action", "{{ route('soal.mc.index') }}/destroy/"+id)
    }
</script>
