@extends('soal.layouts.app', ['pageActive' => 'soal.mc.index', 'pageTitle' => 'Contest Participant'])
@section('header')
<style>
    ul {
        margin: 0;
            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('soal.mc.index') }}">Multiple Choice</a></li>
        ...
        <div class="card-body">
            ...
            <div class="row mb-1">
                <div class="col-4" class="mb-1">
                    ...
                    <form method="post" action="{{ route('soal.mc.participant.store', $contest->id) }}" id="formStoreParticipant">
                        @csrf
            ...
            <table class="table mb-4">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button class="btn btn-outline-danger mt-1" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="getMcDataToDelete({{ $contest->id. ','. $team_join->id }})" style="width:100%;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="" id="participantmcContestDelete">
                    @csrf
            ...
            <div class="modal-footer">
                <button form="participantmcContestDelete" type="submit" class="btn btn-primary" data-bs-dismiss="modal">Delete</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function getMcDataToDelete(contest_id, team_id){
        $("#participantmcContestDelete").attr("action", "{{ route('soal.mc.index') }}/"+contest_id+"/participant/destroy/"+team_id);
    }
