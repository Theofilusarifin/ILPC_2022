                ...
                <div class="misc-wrapper">
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <img style="width: 40%;" src="{{ asset('ilpc2022') }}/identity/logo-no-footer.png"
                                alt="Error page" />
                            <hr>
                            <h2 class="mb-1"><b>WEBSITE IS UNDER MAINTENANCE</b></h2>
                            {{-- <h2 class="mb-1"><b>COMING SOON</b></h2> --}}
                            <hr>
                            <p class="mb-1">For more information</p>
                            <p class="text-secondary"><i data-feather="instagram"></i> ilpc_ubaya</p>
                        </div>
                    </div>
                </div>
                <!-- / Error page-->
